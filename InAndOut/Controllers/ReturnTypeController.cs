...
namespace InAndOut.Controllers
{
    public class ReturnTypeController : Controller
    {
        ...
        /// <summary>
        /// This is a StatusCodeResult. When executed, it will produce an empty Status200OK res
        /// </summary>
        /// <returns></returns>
        ...
        /// do anything else.
        /// In contrast with its counterpart that has many options for
        ...
        /// continue to process the request with the given paload.
        ...
        /// formats the entity body, and will produce a Status200Ok respose
        ...
        /// <summary>
        /// Redirect to specified string URL with permanet 301 property set to false
        /// </summary>
        /// <returns></returns>

        public IActionResult RedirectResult()
        {
            return Redirect("https://ww.google.com");
        }
        ...
        {
            return File("~/download/pdf-smaple.pdf", "application/pdf");
        }
        ...
        /// <summary>
        /// Renders a specifid partial view to the response stream
        /// </summary>
        /// <returns></returns>
